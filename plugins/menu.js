...
┃⬡ Jangan Lupa Subs https://youtube.com/c/Kyluesky
...
┗━━━━━━━━⬣`.trim(),
    ...
    // await conn.send3ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'nekopoi.care', '👤 Pemilik Bot', '.owner', '💵 Donasi', '.donasi', '📜 Rules', '.infobot', m)
    await conn.send3ButtonLoc(m.chat, await (await fetch(`https://i.ibb.co/Ch3X0rH/102eb9ca1fea76f53d3973360654d21a.jpg`)).buffer(), text.trim(), 'nekopoi.care', '👤 Pemilik Bot', '.owner', '💵 Donasi', '.donasi', '📜 Rules', '.infobot', m)
